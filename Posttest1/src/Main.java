    ...
    public static void readService() throws IOException{
        ...
        if (jumlah <= 0){
            ...
            for (int i = 0; i < DataLaptop.size(); i++){
                System.out.println("\n>>> Data Service Ke - " + (i+1));
                System.out.println("--------------------------------------------------------------");
                System.out.println("Merek Laptop    : " + DataLaptop.get(i).merek);
                System.out.println("Seri Laptop     : " + DataLaptop.get(i).seri);
                System.out.println("Pemilik Laptop  : " + DataLaptop.get(i).namapemilik);
                System.out.println("No HP Pemilik   : " + DataLaptop.get(i).nomorhp);
                System.out.println("Kerusakan       : " + DataLaptop.get(i).kerusakan);
                System.out.println("Harga Perbaikan : " + DataLaptop.get(i).hargaperbaikan);
                System.out.println(">>> Teknisi Yang Memperbaiki");

                int dataindex = (DataLaptop.get(i).teknisi)-1;
                ...
                if (dataindex < 0 || dataindex >= DataTeknisi.size()) {
                    ...
                    System.out.println("Nama Teknisi                 : " + DataTeknisi.get(dataindex).nama);
                    System.out.println("Gender (Laki-laki/Perempuan) : " + DataTeknisi.get(dataindex).gender);
                    System.out.println("Nomor HP Teknisi             : " + DataTeknisi.get(dataindex).nomorhp);
                }
                System.out.println("--------------------------------------------------------------");
            }
        }
    ...
    public static void readTeknisi() throws IOException{
        ...
        if (jumlah <= 0){
            ...
            for (int i = 0; i < DataTeknisi.size(); i++){
                System.out.println("\nData Teknisi Ke - " + (i+1));
                System.out.println("Nama Teknisi                 : " + DataTeknisi.get(i).nama);
                System.out.println("Gender (Laki-laki/Perempuan) : " + DataTeknisi.get(i).gender);
                System.out.println("Nomor HP Teknisi             : " + DataTeknisi.get(i).nomorhp);
            }
        }
